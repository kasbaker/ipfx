...
from ipfx.dataset.ephys_nwb_data import EphysNWBData, get_finite_or_none,  EphysNWBDataLRU
...
class MIESNWBDataLRU(EphysNWBDataLRU):
    """
    Provides an Ephys Data Interface to a MIES generated NWB file
    ...
    def __init__(
        ...
        super(MIESNWBDataLRU, self).__init__(
            nwb_file=nwb_file,
            ontology=ontology,
            load_into_memory=load_into_memory,
            validate_stim=validate_stim
